...
- **Step 4 — 4a COMPLETE, 4b 7/8:** only `starledger-template` remains — its CI cannot go green for any PR until the inherited workflows are repaired (decision pending: repair CI in a dedicated PR, then merge the formatting PR #2 and badge PR #1).
